 ...
 */
class getQuestionUserRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\QuestionUserRepository' shared autowired service.
     *
     * @return \App\Repository\QuestionUserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'QuestionUserRepository.php';

        return $container->privates['App\\Repository\\QuestionUserRepository'] = new \App\Repository\QuestionUserRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
