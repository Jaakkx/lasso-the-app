 ...
 */
class getAssociationUserRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AssociationUserRepository' shared autowired service.
     *
     * @return \App\Repository\AssociationUserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AssociationUserRepository.php';

        return $container->privates['App\\Repository\\AssociationUserRepository'] = new \App\Repository\AssociationUserRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
