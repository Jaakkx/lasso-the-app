 ...
 */
final class Version20220324213531 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE association_user (id INT AUTO_INCREMENT NOT NULL, score_update_user INT NOT NULL, association_name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE favoris (id INT AUTO_INCREMENT NOT NULL, associations_id INT DEFAULT NULL, favoris_user_id INT DEFAULT NULL, state TINYINT(1) NOT NULL, INDEX IDX_8933C43212847A90 (favoris_user_id), INDEX IDX_8933C4324122538A (associations_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, associations_id INT DEFAULT NULL, questions_id INT DEFAULT NULL, email VARCHAR(255) NOT NULL, user_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, INDEX IDX_8D93D649BCB134CE (questions_id), INDEX IDX_8D93D6494122538A (associations_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_question_user (user_id INT NOT NULL, question_user_id INT NOT NULL, INDEX IDX_3DF396F6A76ED395 (user_id), INDEX IDX_3DF396F6A9B20688 (question_user_id), PRIMARY KEY(user_id, question_user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE favoris ADD CONSTRAINT FK_8933C43212847A90 FOREIGN KEY (favoris_user_id) REFERENCES user (id)');
        ...
        $this->addSql('ALTER TABLE user_question_user ADD CONSTRAINT FK_3DF396F6A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE user_question_user ADD CONSTRAINT FK_3DF396F6A9B20688 FOREIGN KEY (question_user_id) REFERENCES question_user (id) ON DELETE CASCADE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_question_user DROP FOREIGN KEY FK_3DF396F6A9B20688');
        $this->addSql('ALTER TABLE association_user_user DROP FOREIGN KEY FK_53F593F5A76ED395');
        $this->addSql('ALTER TABLE favoris DROP FOREIGN KEY FK_8933C43212847A90');
        $this->addSql('ALTER TABLE user_question_user DROP FOREIGN KEY FK_3DF396F6A76ED395');
        ...
        $this->addSql('DROP TABLE user_question_user');
    }
}
